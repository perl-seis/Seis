...
--- expected
(statements (class (ident "Point") (nop) (block (statements (has (attribute_variable "$!x")) (method (ident "set_x") (params (param (nop) (variable "$x") (nop) (int 0))) (block (statements (list_assignment (attribute_variable "$!x") (variable "$x"))))) (nop)))))
